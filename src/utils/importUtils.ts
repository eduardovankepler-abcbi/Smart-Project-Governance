...
export async function parseExcelFile(file: File): Promise<ImportResult> {
  ...
  if (projetoSheet) {
    ...
    result.projetos = data.map(r => ({
      ...
      valorPrevisto: num(col(r, "Valor Previsto", "valor_previsto", "Custo Planejado", "custo_planejado")),
      orcamentoAprovado: num(
        col(r, "Orçamento Aprovado", "Orcamento Aprovado", "orcamento_aprovado"),
        num(col(r, "Valor Previsto", "valor_previsto", "Custo Planejado", "custo_planejado")),
      ),
